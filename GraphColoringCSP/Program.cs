    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Constrant<Color>[] constrants = new Constrant<Color>[]
            {
                ...
                new Constrant<Color>(isEqual, new List<Point>{new Point(0,0), new Point(0,1)}),
                new Constrant<Color>(isEqual, new List<Point>{new Point(1,0), new Point(2,0)}),
                new Constrant<Color>(isEqual, new List<Point>{new Point(1,0), new Point(1,1)}),
                new Constrant<Color>(isEqual, new List<Point>{new Point(1,0), new Point(0,0)}),
                new Constrant<Color>(isEqual, new List<Point>{new Point(1,0), new Point(0,1)}),
                ...
                new Constrant<Color>(isEqual, new List<Point>{new Point(2,0), new Point(1,1)}),
                ...
                new Constrant<Color>(isEqual, new List<Point>{new Point(1,1), new Point(0,1)}),
                new Constrant<Color>(isEqual, new List<Point>{new Point(1,1), new Point(1,2)}),
                ...
                new Constrant<Color>(isEqual, new List<Point>{new Point(1,2), new Point(1,1)}),
                new Constrant<Color>(isEqual, new List<Point>{new Point(1,2), new Point(2,1)}),
                new Constrant<Color>(isEqual, new List<Point>{new Point(1,2), new Point(2,2)}),
                new Constrant<Color>(isEqual, new List<Point>{new Point(0,2), new Point(1,2)}),
                new Constrant<Color>(isEqual, new List<Point>{new Point(2,2), new Point(1,2)}),
            };
